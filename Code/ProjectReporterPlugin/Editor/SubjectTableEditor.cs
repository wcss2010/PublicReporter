...
namespace ProjectReporterPlugin.Editor
{
    public partial class SubjectTableEditor : AbstractEditorPlugin.BaseEditor
    {
        ...
        public SubjectTableEditor()
        {
            ...
            //显示图标
            //dgvDetail[dgvDetail.Columns.Count - 1, 0].Value = global::ProjectReporterPlugin.Resource.exclamation_16;
            //dgvDetail[dgvDetail.Columns.Count - 2, 0].Value = global::ProjectReporterPlugin.Resource.DELETE_28;
        ...
        {
            ((DataGridView)sender)[((DataGridView)sender).Columns.Count - 1, e.RowIndex].Value = global::ProjectReporterPlugin.Resource.exclamation_16;
            ((DataGridView)sender)[((DataGridView)sender).Columns.Count - 2, e.RowIndex].Value = global::ProjectReporterPlugin.Resource.DELETE_28;
        ...
        public override void onSaveEvent(ref bool result)
        {
            ...
            if (GetZongZiKetiCount() == 1)
            {
                ...
                //刷新课题阶段划分表
                foreach (BaseEditor be in PublicReporterLib.PluginLoader.getLocalPluginRoot<NewPluginRoot>().editorMap.Values)
                {
