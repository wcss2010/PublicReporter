...
namespace ProjectContractPlugin.Editor
{
    public partial class ProjectStepMoneyEditor : BaseEditor
    {
        public ProjectStepMoneyEditor()
        {
            ...
            //dgvDetail[dgvDetail.Columns.Count - 1, 0].Value = global::ProjectContractPlugin.Resource.DELETE_28;
        }
        ...
        public override void RefreshView()
        {
            ...
            {
                txtTotalTime.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalTime != null ? ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalTime.Value + "" : "0";
                txtTotalMoney.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalMoney != null ? ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalMoney.Value + "" : "0";
                txtStepCount.Text = "0";
        ...
        public override void OnSaveEvent()
        {
            ...
            try
            {
                ...
                //刷新课题阶段划分表
                foreach (BaseEditor be in ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).editorMap.Values)
                {
        ...
        {
            string sourcePath = Path.Combine(((PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).RootDir, Path.Combine("Helper", "jieduanhuafen.xls"));
