...
using ProjectContractPlugin.DB.Services;
...
namespace ProjectContractPlugin.Editor
{
    ...
    {   
        ...
        public void LoadProject()
        {
            ...
            {
                txtProjectName.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Name;
                cbxSecret.SelectedItem = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.SecretLevel;
                txtTotalTime.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalTime + "";
                txtTotalMoney.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalMoney + "";
                txtKeyWords.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Keywords;
                txtDomain.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Domain;
                txtDirection.Text = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Direction;
                txtDirectionCode.Value = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.DirectionCode != null ? ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.DirectionCode.Value : 0;

                Unit unitObj = ConnectionManager.Context.table("Unit").where("ID='" + ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.UnitID + "'").select("*").getItem<Unit>(new Unit());
                if (unitObj != null)
                {
        ...
        private void UpdateUnitList()
        {
            ...
            //if (((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).ProjectObj != null)
            //{
            //    leSearchList.EditValue = ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).ProjectObj.UnitID;
            //}
        }
        ...
        public long SaveProject()
        {
            ...
            //创建单位信息
            string unitExtId = (((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj != null && !string.IsNullOrEmpty(((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.UnitID)) ? ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.UnitID : Guid.NewGuid().ToString();
            ...
            if (((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj == null)
            {
                ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj = new Project();
            }

            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.ParentID = string.Empty;
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.UnitID = unitExtId;
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Type = "项目";
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.SecretLevel = cbxSecret.SelectedItem != null ? cbxSecret.SelectedItem.ToString() : "公开";
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Name = txtProjectName.Text;
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalTime = int.Parse(txtTotalTime.Text);
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.TotalMoney = decimal.Parse(txtTotalMoney.Text);
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Keywords = txtKeyWords.Text;
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Domain = txtDomain.Text;
            ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.Direction = txtDirection.Text;
            ...
            if (string.IsNullOrEmpty(((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.ID))
            {
                ...
                return ((ProjectContractPlugin.PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.copyTo(ConnectionManager.Context.table("Project")).insert();
            }
            else
            {
                //创建候选单位
