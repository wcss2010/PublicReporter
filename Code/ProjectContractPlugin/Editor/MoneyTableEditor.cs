...
namespace ProjectContractPlugin.Editor
{
    public class MoneyTableEditor : BaseEditor
	{
		...
		private ProjectContractPlugin.Controls.HSkinTableLayoutPanel tableLayoutPanel2;

        private ProjectContractPlugin.Controls.HSkinTableLayoutPanel tableLayoutPanel3;
		...
		private void InitializeComponent()
		{
            ...
            this.tableLayoutPanel2 = new ProjectContractPlugin.Controls.HSkinTableLayoutPanel();
            ...
            this.tableLayoutPanel3 = new ProjectContractPlugin.Controls.HSkinTableLayoutPanel();
        ...
        {
            pbinfo = GetBudgetInfoObject(((PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.BianHao);
        }
        ...
        public override void OnSaveEvent()
        {
            ...
            {
                ConnectionManager.Context.table("MoneyAndYear").where("ProjectID='" + ((PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.BianHao + "'").delete();
                if (pbinfo != null)
                {
                    ...
                    foreach (PropertyInfo pi in props)
                    {
                        ...
                        if (val != null)
                        {
                            ...
                            may.ProjectID = ((PluginRoot)PublicReporterLib.PluginLoader.CurrentPlugin).projectObj.BianHao;
                            may.Name = pi.Name;
        ...
        private void btnExcelLoad_Click(object sender, EventArgs e)
        {
            if (ofdExcelDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    DataSet ds = ProjectContractPlugin.Utility.ExcelHelper.ExcelToDataSet(ofdExcelDialog.FileName);
