...
namespace ProjectContractPlugin.Editor
{
    public partial class SubjectTableEditor : BaseEditor
    {
        ...
        public SubjectTableEditor()
        {
            ...
            //显示图标
            //dgvDetail[dgvDetail.Columns.Count - 1, 0].Value = global::ProjectContractPlugin.Resource.exclamation_16;
            //dgvDetail[dgvDetail.Columns.Count - 2, 0].Value = global::ProjectContractPlugin.Resource.DELETE_28;
        ...
        {
            ((DataGridView)sender)[((DataGridView)sender).Columns.Count - 1, e.RowIndex].Value = global::ProjectContractPlugin.Resource.exclamation_16;
            ((DataGridView)sender)[((DataGridView)sender).Columns.Count - 2, e.RowIndex].Value = global::ProjectContractPlugin.Resource.DELETE_28;
