...
namespace ProjectMilitaryTechnologPlanPlugin
{
    public class PluginRoot : IReportPluginRoot
    {
        ...
        {
            #region 初始化文档编辑器
            editorMap.Add("研究状况及选题价值", new DocumentPasteEditor("Docs_A", "1.国内外相关研究的学术史梳理或综述，特别是真实研究现状。2.对已有相关代表性成果及观点做出科学、客观、切实的分析评价，说明进一步探讨、发展或突破的空间，详细说明本选题相对于已有研究的独到价值和意义。"));
            editorMap.Add("总体框架和预期目标", new DocumentPasteEditor("Docs_B", "1.本项目研究的主要问题和内容，总体研究框架，框架各部分之间的内在逻辑关系。2.本项目研究在理论创新、实践应用、服务决策等方面的预期目标。"));
            editorMap.Add("研究思路和研究方法", new DocumentPasteEditor("Docs_C", "1.本项目的总体思路、研究视角和研究路径，具体阐明研究思路的科学性和可行性。2.针对本项目研究问题拟采用的具体研究方法、研究手段和技术路线，说明其适用性和可操作性。"));
            editorMap.Add("重点难点和创新之处", new DocumentPasteEditor("Docs_D", "1.本项目拟解决的关键性问题和重点难点问题，分别阐述提炼这些问题的理由和依据。2.本项目研究在问题选择、学术观点、研究方法、分析工具、文献资料等方面的突破、创新或推进之处。"));
            editorMap.Add("研究进度和任务分工", new DocumentPasteEditor("Docs_E", "1.本项目研究的实地调研（或实验）方案、资料文献搜集整理方案、总体进度安排和年度进展计划。2.牵头单位和参与单位具体任务分工和每年投入时间（月）。3.主要阶段性成果（各单位成果）和最终成果的名称、形式、字数等，成果出版或报送的方式和计划。"));
            #endregion
