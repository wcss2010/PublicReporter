...
namespace ProjectMilitaryTechnologPlanPlugin
{
    public class UIControlConfig
    {
        ...
        /// 参数分割符
        /// </summary>
        public const string ParamSplitFlag = "{{(<<split>>)}}";
        ...
        private static void setDefaultConfig()
        {
            ...
            ConfigObj.Params.Add("研究周期", new string[] { "6个月", "12个月", "18个月", "24个月", "36个月" });
            ConfigObj.Params.Add("项目类别", new string[] { "重大学术研究" + ParamSplitFlag + "[100,180]" + ParamSplitFlag + "[5,10]", "重点学术研究" + ParamSplitFlag + "[90,150]" + ParamSplitFlag + "[3,7]", "能力建设" + ParamSplitFlag + "[100,180]" + ParamSplitFlag + "[5,10]", "专题活动" + ParamSplitFlag + "[100,180]" + ParamSplitFlag + "[5,10]" });
