...
namespace ProjectMilitaryTechnologPlanPlugin
{
    public class UIControlConfig
    {
        ...
        private static void setDefaultConfig()
        {
            ...
            ConfigObj.Params.Add("项目类别", new string[] { "重大学术研究" + rowFlag + "[100,180]" + rowFlag + "[5,10]" + rowFlag + "300", "重点学术研究" + rowFlag + "[90,150]" + rowFlag + "[3,7]" + rowFlag + "100", "能力建设" + rowFlag + "[100,180]" + rowFlag + "[5,10]" + rowFlag + "100", "专题活动" + rowFlag + "[100,180]" + rowFlag + "[5,10]" + rowFlag + "100" });
